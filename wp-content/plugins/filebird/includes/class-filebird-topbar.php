...
class FileBird_Topbar
{
    ...
    public function filebird_enqueue_media_action()
    {
        ...
        wp_register_script('njt-filebird-upload-localize', plugins_url('admin/js/filebird-util.js', dirname(__FILE__)), array('jquery'), $this->plugin_version, false);
        ...
        // wp_enqueue_script('njt-filebird-util', plugins_url('admin/js/filebird-util.js', dirname(__FILE__)), array('jquery'), $this->plugin_version, true);
        // // wp_enqueue_script('njt-filebird-upload-scripts', plugins_url('admin/js/hook-post-add-media.js', dirname(__FILE__)), array('jquery'), $this->plugin_version, true);
