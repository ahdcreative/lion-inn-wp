...
class FileBird
{
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('admin_enqueue_scripts', $plugin_admin, 'enqueue_dragAndDrop');
        ...
        if (defined('ELEMENTOR_VERSION')) {
            add_action('elementor/editor/after_enqueue_scripts', function () {
                ...
                wp_register_script('njt-filebird-upload-localize', NJT_FILEBIRD_PLUGIN_URL . '/admin/js/filebird-util-elementor.js', array('jquery', 'jquery-ui-draggable', 'jquery-ui-droppable'), $this->version, false);
