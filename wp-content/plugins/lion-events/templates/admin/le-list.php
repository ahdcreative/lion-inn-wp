<?php 
    ...
    $tpl = new LETemplate( __DIR__ . '/items' );
?>
            ...
            case "SECTIONS":                       
                foreach($listOf as $sec) {
                    if($sec->side == $side) {
                        ...
                        echo $tpl->render( 'le-section' , $sec );
                    }
                }
                break;
            ...
            case "SUBITEMS":
                if(!$listOf && !$isSubsec && !$isNote) {  
                    ...
                    foreach($listOf as $subitem) {
                        ...
                        echo $tpl->render( 'le-subitem' , $subitem );
                    }
                }
                break;
