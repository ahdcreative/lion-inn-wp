	...
	private static function display_feedback_form( $form ) {   ?>
		...
		<div class="form_options">
            <div class="ekb-feedback-type-container">
                ...
                <a href="http://www.echoknowledgebase.com/contact-us/?inquiry-type=technical" class="ekb-feedback-btn" target="_blank"><?php _e('Technical Support', 'echo-knowledge-base' ); ?><span class="icon_tools"></span></a>
