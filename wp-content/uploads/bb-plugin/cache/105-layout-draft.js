var wpAjaxUrl = 'http://localhost:81/wordpress/wp-admin/admin-ajax.php';var flBuilderUrl = 'http://localhost:81/wordpress/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'http://localhost:81/wordpress/wp-content/plugins/beaver-builder-lite-version/',
		wpAjaxUrl : 'http://localhost:81/wordpress/wp-admin/admin-ajax.php'
	},
	breakpoints : {
		small  : 768,
		medium : 992	},
